...
public class News extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
     ...
     GetRSSDataTaskNews task = new GetRSSDataTaskNews(this);
		
		// Start download RSS task
     task.execute("http://www.aueb.gr/pages/news/RSS/anakoinoseis_pryt.xml");
    ...
    class GetRSSDataTaskNews extends AsyncTask<String, Void, List<Message> > {
	
    	private News activity;
    	
    	public GetRSSDataTaskNews(News a){
    		super();
    		this.activity=a;
    	}
